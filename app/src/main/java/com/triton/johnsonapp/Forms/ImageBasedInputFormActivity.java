...
public class ImageBasedInputFormActivity extends AppCompatActivity {
    ...
    ImageBasedArrayListAdapter imageBasedArrayListAdapter;
    @SuppressLint("NonConstantResourceId")
    ...
    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.txt_job_no1)
    TextView txt_job_no1;
    ...
    private String status,sucessCount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_job_no1.setText("Job No : " + job_id);
                ...
                public void onClick(View view) {
                    if(edt_inputValue1.getText().toString().equals("")||edt_inputValue2.getText().toString().equals("")){
                        ...
                        if(Data != null && Data.size()>0){
                            ...
                            sucessCount = String.valueOf(imageBasedArrayListAdapter.getItemCount());
...
//                            }
                        ...
                        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ImageBasedInputFormActivity.this);
    ...
    private void setView() {
        ...
        imageBasedArrayListAdapter = new ImageBasedArrayListAdapter(this, Data);
