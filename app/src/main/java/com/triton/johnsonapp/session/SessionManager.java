package com.triton.johnsonapp.session;
...
public class SessionManager {
    ...
    public static final String KEY_IMIECODE = "imiecode";
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        Log.w(TAG,"KEY_ID :"+KEY_ID+" KEY_ROLE : "+KEY_ROLE+" KEY_USERROLE : "+KEY_USERROLE+"location"+KEY_LOCATION);
        return user;
...
/*    public void createLoginSession(String message, String user_level, String station_code, String role, String station_name, String empid, String name, String username, String mobile) {
    ...
    public void createSessionLogin(String id,String userid, String username,String user_email, String designation, String token, String status, String user_type,String user_role,String imie_code,String agent_code,String location) {
        editor.putBoolean(IS_LOGIN, true);
        ...
        editor.putString(KEY_IMIECODE,imie_code);
        editor.putString(KEY_AGENTCODE,agent_code);
