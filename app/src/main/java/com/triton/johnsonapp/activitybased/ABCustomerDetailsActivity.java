...
public class ABCustomerDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Hi Nish","Customer Details Page");
...
//        }
        ...
        if (UKEY.equals("ESPD-ACT2") || UKEY.equals("ESPD-ACT3") || UKEY.equals("ESPD-ACT6")|| UKEY.equals("OP-ACT1")|| UKEY.equals("OP-ACT2")|| UKEY.equals("OP-ACT4")|| UKEY.equals("OP-ACT5")|| UKEY.equals("OP-ACT6")|| UKEY.equals("OP-ACT8")){
            ...
            img_pdf.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(ABCustomerDetailsActivity.this, PDF_ListActivity.class);
                    intent.putExtra("UKEY",UKEY);
                    intent.putExtra("job_id",job_id);
                    startActivity(intent);
                }
            ...
            public void onClick(View view) {
                ...
                if (form_type == 1) {
                    ...
                    if (UKEY.equals("ESPD-ACT1")){
                        ...
                        Intent intent = new Intent(getApplicationContext(), InfoList_Activity.class);
