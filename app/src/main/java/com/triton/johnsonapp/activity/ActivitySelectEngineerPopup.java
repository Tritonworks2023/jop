...
public class ActivitySelectEngineerPopup extends AppCompatActivity implements PetBreedTypeSelectListener {
    ...
    String Valueeee, str_user_mobileno, str_user_location,sendselectEng;
    @SuppressLint("NonConstantResourceId")
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /*      edt_search.setOnEditorActionListener(new TextView.OnEditorActionListener() {
        ...
        Log.i(  "Mobile Number 2",""+ str_user_mobileno);
        Log.i("Location 2",""+ str_user_location);
...
//
//                for(BreedTypeResponse1.DataBean data:breedTypedataBeanList){
//                    if(data.getName().equals(getname)){F
//                        sendselectEng = data.getName();
//                    }
//                }
//                Log.i(TAG,"getname value"+getname);
    ...
    private void breedTypeResponseByPetIdCall() {
        ...
        call.enqueue(new Callback<BreedTypeResponse1>() {
            private String TAG = ActivitySelectEngineerPopup.class.getSimpleName();
...
//                                String extractedString = parts[0] + "," + parts[1];
//                                Log.w(TAG, "spr string-->extractedString" + extractedString);
                                names.add(string);
    ...
    private void SubmitDialog(){
        AlertDialog.Builder builder  = new AlertDialog.Builder(ActivitySelectEngineerPopup.this);
        builder.setTitle("DO YOU WANT TO SAVE");
        builder.setMessage(Valueeee);
        ...
        alertDialog = builder.create(); // Initialize the AlertDialog object
        alertDialog.show();
    }
}
