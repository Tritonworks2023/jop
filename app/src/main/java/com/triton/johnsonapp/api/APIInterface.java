...
public interface APIInterface {
    ...
    @POST("activity/check_file_name")
    Call<PDFListResponse> pdflistResponseCall(@Header("Content-Type") String type, @Body PDFListRequest pdflistRequest);
    ...
    @GET("activity/operation_activity_list")
    Call<WorksheetEmpactivityResponse> emp_activity_worksheetResponseCall(@Header("Content-Type") String type);

    @POST("service_attendance/operation_work_sheet_get_list")

    Call<Worksheet_SubmitResponse> Worksheet_SubmitResponseCall(@Header("Content-Type") String type, @Body Worksheet_SubmitRequest worksheet_submitRequest);

    @POST("service_attendance/operation_work_sheet_insert")
    Call<WorksheetSubmitResponse> WorksheetSubmitResponseCall(@Header("Content-Type") String type, @Body WorksheetSubmitRequest worksheet_submitRequest);

    @POST("service_attendance/Update_operation_work_sheet_insert")
    Call<WorksheetSubmitResponse> WorksheetUpdateResponseCall(@Header("Content-Type") String type, @Body WorksheetSubmitRequest worksheet_submitRequest);

    @POST("service_attendance/job_list_work_activity")
    Call<Worksheet_jobno_listResponse> Worksheet_jobno_listResponseCall(@Header("Content-Type") String type, @Body Worksheet_jobno_listRequest activityListManagementRequest);
    ...
    @POST("activity/update_basement_value")
    Call<Basemant_updateResponse> basemant_updateResponseCall(@Header("Content-Type") String type, @Body Basemant_updateRequest check_local_statusRequest);
...
*/
    ...
    @POST("activity/safetyImages")
    Call<SafetyImageResponse>safeyimageresponsecall(@Header("Content-Type") String type, @Body ImageSafetyRequest imageSafetyRequest);
