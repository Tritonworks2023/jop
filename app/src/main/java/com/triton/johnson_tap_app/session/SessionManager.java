...
/*    public void createLoginSession(String message, String user_level, String station_code, String role, String station_name, String empid, String name, String username, String mobile) {
    ...
    public void createSessionLogin(String id, String userid, String username, String user_email, String designation, String token, String status, String user_type, String user_role, String user_agent_code, String agent_code, String location) {
        editor.putBoolean(IS_LOGIN, true);
